...
# -*- coding: utf-8 -*-
"""
Creates a 3x3 electric field slice figure:
...
Columns are colored by Ex, Ey, Ez. Quivers show projected field direction.
"""
...
for sim_step in sim_steps:
    ...
    # Save
    outpath = os.path.join(out_folder, f"{case}_{mode}_efield_slices_{sim_step:06d}.png")
