...
indir = f"/Users/danywaller/Projects/mercury/extreme/surface_flux_timeseries/RPS_HNHV/"
plot_folder_ts = os.path.join(indir, f"total/")
output_file = os.path.join(indir, f"{base}_total_flux_timeseries.gif")
