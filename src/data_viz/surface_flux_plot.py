...
# Configuration
# -------------------------------
input_folder1  = "/Users/danywaller/Projects/mercury/RPS_Base/object/"
input_folder2 = "/Users/danywaller/Projects/mercury/CPS_Base/object/"
output_folder = "/Users/danywaller/Projects/mercury/RPS-CPS_surface_density/"
    ...
    if not near_far:
        ...
        fig.add_trace(
            go.Surface(
                ...
                cmin=c_min,
                cmax=c_max,
                colorbar=dict(title="Radial flux (cm^-2 s^-1)", len=0.5,
...
if not all_one:
    ...
    fig = go.Figure(
        go.Surface(
            ...
            cmin=c_min,
            cmax=c_max,
            colorbar=dict(title="Radial flux (cm^-2 s^-1)"),
        )
    )
    ...
    fig2.add_trace(
        go.Scattergl(
            ...
            marker=dict(
                ...
                cmin=c_min,
                cmax=c_max,
                colorbar=dict(title="Radial flux (cm^-2 s^-1)", len=0.45),
            ),
            showlegend=False,
        ),
        row=1, col=1
    ...
    fig2.write_image(outfile_png, width=800, height=800, scale=2)  # scale=2 for higher resolution
    print("Saved:", outfile_png)
